...
* Add the `.vs` folder to the default exclusions. [PR [#9629](https://github.com/Microsoft/vscode-cpptools/issues/9629)](https://github.com/microsoft/vscode-cpptools/pull/9629)
